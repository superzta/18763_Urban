"""
FCOS Inference Script
=====================
Script to run inference using FCOS model.
"""
...
from fcos import inference

def main():
    print("=" * 80)
    print("FCOS Inference Tool")
    print("=" * 80)
    ...
    checkpoint_input = input("Checkpoint path (default: checkpoints/fcos_best_model.pth): ").strip()
    ...
    save_path = os.path.join(config.output_dir, f'{image_name}_fcos_{timestamp}.jpg')

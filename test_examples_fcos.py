"""
FCOS Testing Examples
=====================
Shows how to test FCOS on different combinations of urban issue classes.
"""

from rcnn import Config
from fcos import test

def example_1_single_class(checkpoint_path='checkpoints/fcos_best_model.pth'):
    """Example 1: Test on single class (Broken Road Signs)"""
    print("\n" + "="*80)
    print("EXAMPLE 1: Testing FCOS on Single Class (Broken Road Signs)")
    print("="*80)
...
def example_2_road_issues(checkpoint_path='checkpoints/fcos_best_model.pth'):
...
def example_5_all_classes(checkpoint_path='checkpoints/fcos_best_model.pth'):
    ...
    print("\n" + "="*80)
    print("EXAMPLE 5: Testing FCOS on ALL Classes (Comprehensive Model)")
    print("="*80)
...
if __name__ == '__main__':
    ...
    print("="*80)
    print("FCOS Testing Examples")
    print("="*80)
    
    checkpoint_input = input("\nEnter checkpoint path (default: checkpoints/fcos_best_model.pth): ").strip()
    checkpoint_path = checkpoint_input if checkpoint_input else 'checkpoints/fcos_best_model.pth'

...
def example_1_single_class(checkpoint_path = 'checkpoints/best_model_rcnn.pth'):
...
def example_2_road_issues(checkpoint_path = 'checkpoints/best_model_rcnn.pth'):
...
def example_3_infrastructure(checkpoint_path = 'checkpoints/best_model_rcnn.pth'):
...
def example_4_environmental(checkpoint_path = 'checkpoints/best_model_rcnn.pth'):
...
def example_5_all_classes(checkpoint_path = 'checkpoints/best_model_rcnn.pth'):
...
if __name__ == '__main__':
    ...
    if choice == '1' or choice == '':
        ...
        example_3_infrastructure(checkpoint_path)
    elif choice == '4':
        example_4_environmental(checkpoint_path)
    elif choice == '5':
